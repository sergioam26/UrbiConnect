...
class ExportService {
  // Generar y descargar CSV de incidencias
  static Future<void> exportIncidentsToCSV(List<Incident> incidents,
    ...
    // Añadimos el BOM (Byte Order Mark) de UTF-8 para que Microsoft Excel detecte
    // la codificación y muestre acentos (á, é, í, ó, ú) y la 'ñ' correctamente.
    csvBuffer.write('\uFEFF');

    // Cabeceras de columna descriptivas respetando mayúsculas en español
    csvBuffer.writeln(
  ...
  // Exportar Listado de Incidencias en PDF (A través del dialogo de impresión nativo)
  static void exportIncidentsToPDF(List<Incident> incidents,
      Map<String, String> categoryNames, Map<String, String> userEmails) {
    ...
    // Abrir de forma segura usando un elemento Anchor silencioso para evitar errores de '_DOMWindowCrossFrame'
    html.AnchorElement(href: url)
      ..target = '_blank'
      ..click();
  }

  // Exportar Estadísticas Analíticas en PDF (A través del dialogo de impresión nativo)
  static void exportStatsToPDF({
