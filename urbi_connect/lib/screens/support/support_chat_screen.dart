        ...
        actions: widget.isAdmin
            ? [
                PopupMenuButton<String>(
                  onSelected: (val) =>
                      _supportService.updateTicketStatus(widget.ticketId, val),
                  itemBuilder: (context) => [
                    const PopupMenuItem(
                        value: 'Abierto', child: Text('Marcar abierto')),
                    const PopupMenuItem(
                        value: 'En proceso', child: Text('Marcar en proceso')),
                    const PopupMenuItem(
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return _buildMessageBubble(
                        msg['mensaje'], isMe, msg['fecha'], msg['id_emisor']);
                  },
                );
              },
            ),
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Text(
                    'Ticket #${widget.ticketId.substring(0, 5).toUpperCase()}',
